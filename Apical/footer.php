...
<div class="publicite baspage">
    <div class="pubhebergement">
        ...
        <p><a href="https://www.a2hosting.com?aid=5ca65a17be949&amp;bid=ed1c4a67" target="_top"><img
                        src="//affiliates.a2hosting.com/accounts/default1/banners/ed1c4a67.jpg" alt="" title=""
                        width="728" height="90"/></a><img style="border:0"
                                                          src="https://affiliates.a2hosting.com/scripts/imp.php?aid=5ca65a17be949&amp;bid=ed1c4a67"
...
<div class="popupchristiane" id="popuprecherche">
    <form method="get" action="https://apical.xyz/rechercherFormationsPagesAjax">
        ...
        <a id="soumettrerecherche" href="#"><img src="https://apical.xyz/medias/commun/BoutonRechercher.svg"
                                                 class="boutonrechercher" title="Rechercher dans tout le site"
                                                 alt="Soumettre"/></a>
    </form>
...
<div class="popupchristiane" id="popupauthentification">
    ...
    <form method="post" action="<?php echo wp_login_url(); ?>" class="form-horizontal">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="log" id="user_login" autofocus>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <div class="form-check">
                    <label for="rememberme" class="form-check-label" checked>
